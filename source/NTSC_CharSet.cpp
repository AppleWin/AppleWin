...
unsigned char csbits_hebrew[2][256][8];		// Hebrew
...
void make_csbits(void)
{
	...
	get_csbits(&csbits_hebrew[0],     TEXT("CHARSETHE"), 0);	// Hebrew: Alt char set off
	get_csbits(&csbits_hebrew[1],     TEXT("CHARSETHE"), 16);	// Hebrew: Alt char set on
