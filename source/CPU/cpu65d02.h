...
/*
			...
			case 0x1E:       ABSX_OPT ASL_CMOS  CYC(6)  break;
			...
			case 0x3E:       ABSX_OPT ROL_CMOS  CYC(6)  break;
			...
			case 0x5C:   INV ABSX_OPT NOP       CYC(8)  break;
			case 0x5D:       ABSX_OPT EOR       CYC(4)  break;
			case 0x5E:       ABSX_OPT LSR_CMOS  CYC(6)  break;
			...
			case 0x71:       INDY_OPT ADC_CMOS  CYC(5)  break;
			...
			case 0xF1:       INDY_OPT SBC_CMOS  CYC(5)  break;
			...
			case 0xF9:       ABSY_OPT SBC_CMOS  CYC(4)  break;
