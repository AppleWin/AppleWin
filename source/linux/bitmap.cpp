...
namespace
{
  ...
  template<typename T>
  T getAs(const unsigned char * buffer, const size_t bufferSize, const size_t offset)
  {
  ...
  bool extractBitmapData(const unsigned char * buffer, const size_t bufferSize, int32_t & width, int32_t & height, uint16_t & bpp,
