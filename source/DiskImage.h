...
void ImageReadTrack(ImageInfo* const pImageInfo, const int nTrack, const int nHalfTrack, const int nQuarterTrack, LPBYTE pTrackImageBuffer, int* pNibbles, UINT* pBitCount, bool enhanceDisk);
